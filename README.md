...
Perl Diver source code available on GitHub @ [https://github.com/mrrena/perldiver][8]. Blog post with screenshot and how-tos on hiding Perl Diver using a *robots.txt* file and password protecting your perldiver directory using Apache's *htpasswd* [Perl Diver 2.33: Download and Installation][9]
